...
class TestGeneratorAnalyzer:
    ...
    def analyze_questions(self):
        ...
        # Precomputa il conteggio per upper e lower group
        ...
        for student_id, result in upper_group:
            ...
            for q_num, ans_data in result["answers"].items():
                ...
                if sheet_name not in seen_sheets and ans_data["response"] != "blank" and ans_data["response"].upper() == ans_data["correct"].upper():
        ...
        for sheet_name, stats in self.question_analytics.items():
            ...
            # Recupera quanti in ogni gruppo hanno risposto correttamente a questa domanda
